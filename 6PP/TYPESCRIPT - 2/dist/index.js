...
let nambo = "Hello"; // or let nambov1=<string>"Hello"
let num = 343; // or let numV1 = <number>343
let check = true; // or let checkV1 = <boolean>true
// console.log(">>>>>",checkV1)
console.log(nambo);
console.log(num);
console.log(check);
let anyTypeVar = "Hello"; // avoid any as we have to be very type specific.when the type is undecided use any in extreme cases.use it for testing.
