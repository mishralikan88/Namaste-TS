...
==================
  ...
  //  "rootDir": "./src",     => This is the source where tsc finds the ts files.
  //  "outDir": "./dist",     => This is the destination where tsc exports the transpiled js files.
  //  "target": "es2016",     => This version supports features assotiated with es2016
