...
Enums in typescript are commonly used when we want to represent a set of related values and choose one value from multiple options.Enum
provides a convenient way to define a set of named values and associate them with specific meanings.
